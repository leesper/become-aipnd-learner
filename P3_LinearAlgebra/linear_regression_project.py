...
# TODO 证明：
# 因为I为单位阵，Z为全0矩阵，Y的第一列全0，那么矩阵A对角线以下一定全0，且对角线上存在0
# 
# 这说明矩阵A为一个三角矩阵（triangular matrix)
# 
# 根据《线性代数及其应用》第三章行列式，定理2：若A为三角矩阵，则A的行列式为主对角线上元素乘积。
# 
# 得到detA = 0，矩阵A行列式为0，进一步说明A不可逆，根据定义，A为奇异矩阵。
